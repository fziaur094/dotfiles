...
RIO_WORKSPACE_SCRIPTS_DIR="${RIO_WORKSPACE_SCRIPTS_DIR:-$RIO_WORKSPACE_DIR/workspace-scripts}"
RIO_CDVR_DIR="${RIO_CDVR_DIR:-$RIO_WORKSPACE_DIR/src/github.com/rio-cdvr}"
VIPER_COG_DIR="${VIPER_COG_DIR:-$RIO_WORKSPACE_DIR/src/github.comcast.com/viper-cog}"
export RIO_WORKSPACE_DIR RIO_WORKSPACE_SCRIPTS_DIR RIO_CDVR_DIR VIPER_COG_DIR
